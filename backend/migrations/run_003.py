"""
Прогон миграции 003 (привязка к verification) в двух режимах:
...
Запуск: venv/bin/python3 migrations/run_003.py test
"""
...
SQL_PATH = os.path.join(BASE, "migrations", "003_email_queue_ref.sql")
