...
# Тип хранится русской строкой (см. TASK_TYPES в app/api/crm.py).
# Раньше здесь стояли английские ключи, и подпись всегда падала
# в запасное «Напоминание».
TYPE_LABEL = {
    "позвонить": "Позвонить", "написать": "Написать", "замер": "Замер",
    "отправить фото": "Отправить фото", "отправить КП": "Отправить КП",
    "запросить оплату": "Запросить оплату",
    "уточнить доставку": "Уточнить доставку", "другое": "Напоминание",
}
